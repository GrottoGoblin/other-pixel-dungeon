...
package com.grottogoblin.otherpixeldungeon.desktop;
...
import com.grottogoblin.otherpixeldungeon.services.news.NewsImpl;
import com.grottogoblin.otherpixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.grottogoblin.otherpixeldungeon.", "");
		...
		// (e.g. /.grottogoblin/otherpixeldungeon), but we have too much existing save
		...
		new Lwjgl3Application(new otherpixeldungeon(new DesktopPlatformSupport()), config);
	}
}
