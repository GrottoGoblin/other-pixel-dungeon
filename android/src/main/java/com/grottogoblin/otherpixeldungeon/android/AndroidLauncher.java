...
package com.grottogoblin.otherpixeldungeon.android;
...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			SPDSettings.set(instance.getPreferences("otherpixeldungeon"));
		...
		initialize(new otherpixeldungeon(support), config);
