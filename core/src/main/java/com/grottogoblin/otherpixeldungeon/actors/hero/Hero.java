...
package com.grottogoblin.otherpixeldungeon.actors.hero;

import com.grottogoblin.otherpixeldungeon.Assets;
import com.grottogoblin.otherpixeldungeon.Badges;
import com.grottogoblin.otherpixeldungeon.Bones;
import com.grottogoblin.otherpixeldungeon.Dungeon;
import com.grottogoblin.otherpixeldungeon.GamesInProgress;
import com.grottogoblin.otherpixeldungeon.SPDSettings;
...
import com.grottogoblin.otherpixeldungeon.actors.blobs.SacrificialFire;
import com.grottogoblin.otherpixeldungeon.actors.buffs.AdrenalineSurge;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Amok;
import com.grottogoblin.otherpixeldungeon.actors.buffs.AnkhInvulnerability;
import com.grottogoblin.otherpixeldungeon.actors.buffs.ArtifactRecharge;
import com.grottogoblin.otherpixeldungeon.actors.buffs.AscensionChallenge;
...
import com.grottogoblin.otherpixeldungeon.actors.buffs.Barrier;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Berserk;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Bless;
...
import com.grottogoblin.otherpixeldungeon.actors.buffs.Drowsy;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Foresight;
import com.grottogoblin.otherpixeldungeon.actors.buffs.HoldFast;
...
import com.grottogoblin.otherpixeldungeon.actors.buffs.Levitation;
import com.grottogoblin.otherpixeldungeon.actors.buffs.LostInventory;
import com.grottogoblin.otherpixeldungeon.actors.buffs.MindVision;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Momentum;
import com.grottogoblin.otherpixeldungeon.actors.buffs.MonkEnergy;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Paralysis;
import com.grottogoblin.otherpixeldungeon.actors.buffs.PhysicalEmpower;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Recharging;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Regeneration;
import com.grottogoblin.otherpixeldungeon.actors.buffs.SnipersMark;
import com.grottogoblin.otherpixeldungeon.actors.buffs.Vertigo;
import com.grottogoblin.otherpixeldungeon.actors.hero.abilities.ArmorAbility;
import com.grottogoblin.otherpixeldungeon.actors.hero.abilities.duelist.Challenge;
import com.grottogoblin.otherpixeldungeon.actors.hero.abilities.duelist.ElementalStrike;
import com.grottogoblin.otherpixeldungeon.actors.hero.abilities.huntress.NaturesPower;
import com.grottogoblin.otherpixeldungeon.actors.hero.abilities.warrior.Endure;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Mimic;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Mob;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Monk;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Snake;
import com.grottogoblin.otherpixeldungeon.effects.CellEmitter;
import com.grottogoblin.otherpixeldungeon.effects.CheckedCell;
import com.grottogoblin.otherpixeldungeon.effects.Speck;
import com.grottogoblin.otherpixeldungeon.effects.SpellSprite;
import com.grottogoblin.otherpixeldungeon.items.Amulet;
import com.grottogoblin.otherpixeldungeon.items.Ankh;
import com.grottogoblin.otherpixeldungeon.items.Dewdrop;
import com.grottogoblin.otherpixeldungeon.items.EquipableItem;
import com.grottogoblin.otherpixeldungeon.items.Heap;
import com.grottogoblin.otherpixeldungeon.items.Heap.Type;
import com.grottogoblin.otherpixeldungeon.items.Item;
import com.grottogoblin.otherpixeldungeon.items.KindOfWeapon;
...
import com.grottogoblin.otherpixeldungeon.items.armor.glyphs.AntiMagic;
import com.grottogoblin.otherpixeldungeon.items.armor.glyphs.Brimstone;
import com.grottogoblin.otherpixeldungeon.items.armor.glyphs.Viscosity;
import com.grottogoblin.otherpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.grottogoblin.otherpixeldungeon.items.artifacts.CapeOfThorns;
...
import com.grottogoblin.otherpixeldungeon.items.bags.MagicalHolster;
import com.grottogoblin.otherpixeldungeon.items.journal.Guidebook;
import com.grottogoblin.otherpixeldungeon.items.keys.CrystalKey;
import com.grottogoblin.otherpixeldungeon.items.keys.GoldenKey;
import com.grottogoblin.otherpixeldungeon.items.keys.IronKey;
import com.grottogoblin.otherpixeldungeon.items.keys.Key;
import com.grottogoblin.otherpixeldungeon.items.keys.SkeletonKey;
...
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.grottogoblin.otherpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
import com.grottogoblin.otherpixeldungeon.items.quest.DarkGold;
import com.grottogoblin.otherpixeldungeon.items.quest.Pickaxe;
...
import com.grottogoblin.otherpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.grottogoblin.otherpixeldungeon.items.weapon.SpiritBow;
...
import com.grottogoblin.otherpixeldungeon.journal.Notes;
import com.grottogoblin.otherpixeldungeon.levels.Level;
import com.grottogoblin.otherpixeldungeon.levels.MiningLevel;
import com.grottogoblin.otherpixeldungeon.levels.Terrain;
import com.grottogoblin.otherpixeldungeon.levels.features.Chasm;
import com.grottogoblin.otherpixeldungeon.levels.features.LevelTransition;
import com.grottogoblin.otherpixeldungeon.levels.traps.Trap;
import com.grottogoblin.otherpixeldungeon.mechanics.ShadowCaster;
...
import com.grottogoblin.otherpixeldungeon.scenes.InterlevelScene;
import com.grottogoblin.otherpixeldungeon.scenes.PixelScene;
import com.grottogoblin.otherpixeldungeon.scenes.SurfaceScene;
...
import com.grottogoblin.otherpixeldungeon.ui.AttackIndicator;
import com.grottogoblin.otherpixeldungeon.ui.BuffIndicator;
import com.grottogoblin.otherpixeldungeon.ui.QuickSlotButton;
import com.grottogoblin.otherpixeldungeon.ui.StatusPane;
import com.grottogoblin.otherpixeldungeon.utils.GLog;
import com.grottogoblin.otherpixeldungeon.windows.WndHero;
import com.grottogoblin.otherpixeldungeon.windows.WndMessage;
import com.grottogoblin.otherpixeldungeon.windows.WndOptions;
import com.grottogoblin.otherpixeldungeon.windows.WndResurrect;
import com.grottogoblin.otherpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			otherpixeldungeon.switchScene(AlchemyScene.class);
			return false;
