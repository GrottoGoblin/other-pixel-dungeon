...
package com.grottogoblin.otherpixeldungeon.scenes;
...
import com.grottogoblin.otherpixeldungeon.actors.mobs.DemonSpawner;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Ghoul;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Mob;
import com.grottogoblin.otherpixeldungeon.actors.mobs.Snake;
import com.grottogoblin.otherpixeldungeon.effects.BannerSprites;
import com.grottogoblin.otherpixeldungeon.effects.BlobEmitter;
import com.grottogoblin.otherpixeldungeon.effects.EmoIcon;
import com.grottogoblin.otherpixeldungeon.effects.Flare;
import com.grottogoblin.otherpixeldungeon.effects.FloatingText;
import com.grottogoblin.otherpixeldungeon.effects.Ripple;
...
import com.grottogoblin.otherpixeldungeon.items.Honeypot;
...
import com.grottogoblin.otherpixeldungeon.journal.Journal;
import com.grottogoblin.otherpixeldungeon.levels.Level;
import com.grottogoblin.otherpixeldungeon.levels.MiningLevel;
import com.grottogoblin.otherpixeldungeon.levels.RegularLevel;
import com.grottogoblin.otherpixeldungeon.levels.Terrain;
import com.grottogoblin.otherpixeldungeon.levels.rooms.Room;
import com.grottogoblin.otherpixeldungeon.levels.rooms.secret.SecretRoom;
...
import com.grottogoblin.otherpixeldungeon.sprites.DiscardedItemSprite;
import com.grottogoblin.otherpixeldungeon.sprites.HeroSprite;
import com.grottogoblin.otherpixeldungeon.sprites.ItemSprite;
import com.grottogoblin.otherpixeldungeon.tiles.CustomTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.DungeonTerrainTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.DungeonTileSheet;
import com.grottogoblin.otherpixeldungeon.tiles.DungeonTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.DungeonWallsTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.FogOfWar;
import com.grottogoblin.otherpixeldungeon.tiles.GridTileMap;
import com.grottogoblin.otherpixeldungeon.tiles.RaisedTerrainTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.TerrainFeaturesTilemap;
import com.grottogoblin.otherpixeldungeon.tiles.WallBlockingTilemap;
import com.grottogoblin.otherpixeldungeon.ui.ActionIndicator;
import com.grottogoblin.otherpixeldungeon.ui.AttackIndicator;
import com.grottogoblin.otherpixeldungeon.ui.Banner;
import com.grottogoblin.otherpixeldungeon.ui.BossHealthBar;
import com.grottogoblin.otherpixeldungeon.ui.CharHealthIndicator;
import com.grottogoblin.otherpixeldungeon.ui.GameLog;
import com.grottogoblin.otherpixeldungeon.ui.Icons;
import com.grottogoblin.otherpixeldungeon.ui.InventoryPane;
import com.grottogoblin.otherpixeldungeon.ui.LootIndicator;
import com.grottogoblin.otherpixeldungeon.ui.MenuPane;
import com.grottogoblin.otherpixeldungeon.ui.QuickSlotButton;
import com.grottogoblin.otherpixeldungeon.ui.ResumeIndicator;
import com.grottogoblin.otherpixeldungeon.ui.RightClickMenu;
import com.grottogoblin.otherpixeldungeon.ui.StatusPane;
import com.grottogoblin.otherpixeldungeon.ui.StyledButton;
import com.grottogoblin.otherpixeldungeon.ui.Tag;
import com.grottogoblin.otherpixeldungeon.ui.TargetHealthIndicator;
import com.grottogoblin.otherpixeldungeon.ui.Toast;
import com.grottogoblin.otherpixeldungeon.ui.Toolbar;
import com.grottogoblin.otherpixeldungeon.ui.Window;
import com.grottogoblin.otherpixeldungeon.utils.GLog;
import com.grottogoblin.otherpixeldungeon.windows.WndBag;
import com.grottogoblin.otherpixeldungeon.windows.WndGame;
import com.grottogoblin.otherpixeldungeon.windows.WndHero;
import com.grottogoblin.otherpixeldungeon.windows.WndInfoCell;
import com.grottogoblin.otherpixeldungeon.windows.WndInfoItem;
import com.grottogoblin.otherpixeldungeon.windows.WndInfoMob;
import com.grottogoblin.otherpixeldungeon.windows.WndInfoPlant;
import com.grottogoblin.otherpixeldungeon.windows.WndInfoTrap;
import com.grottogoblin.otherpixeldungeon.windows.WndKeyBindings;
...
import com.grottogoblin.otherpixeldungeon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if (Dungeon.hero == null || Dungeon.level == null){
			otherpixeldungeon.switchNoFade(TitleScene.class);
			return;
		}
	...
	public boolean waitForActorThread(int msToWait, boolean interrupt){
		...
		synchronized (actorThread) {
			...
			try {
				...
				otherpixeldungeon.reportException(e);
			}
	...
	public static void gameOver() {
		...
		StyledButton restart = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(StartScene.class, "new"), 9){
			...
			protected void onClick() {
				...
				otherpixeldungeon.switchScene(HeroSelectScene.class);
			}
