...
import com.grottogoblin.otherpixeldungeon.ui.Archs;
...
import com.grottogoblin.otherpixeldungeon.ui.ScrollPane;
import com.grottogoblin.otherpixeldungeon.ui.StyledButton;
import com.grottogoblin.otherpixeldungeon.ui.Window;
import com.grottogoblin.otherpixeldungeon.ui.changelist.ChangeInfo;
import com.grottogoblin.otherpixeldungeon.ui.changelist.WndChanges;
import com.grottogoblin.otherpixeldungeon.ui.changelist.WndChangesTabbed;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_1_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_2_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_3_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_4_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_5_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_6_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_7_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_8_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v0_9_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v1_X_Changes;
import com.grottogoblin.otherpixeldungeon.ui.changelist.v2_X_Changes;
...
public class ChangesScene extends PixelScene {
		...
		StyledButton btn2_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "2.X"){
			...
			protected void onClick() {
				...
				if (changesSelected != 0) {
					changesSelected = 0;
					otherpixeldungeon.seamlessResetScene();
				}
			}
		};
	...
	public static void showChangeInfo(Image icon, String title, String... messages){
		Scene s = otherpixeldungeon.scene();
