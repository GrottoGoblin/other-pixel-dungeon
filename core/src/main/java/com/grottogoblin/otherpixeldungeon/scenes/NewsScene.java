...
import com.grottogoblin.otherpixeldungeon.services.news.NewsArticle;
...
import com.grottogoblin.otherpixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				super.onClick();
				String link = "https://grottogoblin.com";
				//tracking codes, so that the website knows where this pageview came from
				link += "?utm_source=shatteredpd";
				link += "&utm_medium=news_page";
				link += "&utm_campaign=ingame_link";
				otherpixeldungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			otherpixeldungeon.scene().addToFront(new WndArticle(article));
		}
	}
