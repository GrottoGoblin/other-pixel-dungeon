...
import com.grottogoblin.otherpixeldungeon.effects.Fireball;
import com.grottogoblin.otherpixeldungeon.messages.Languages;
import com.grottogoblin.otherpixeldungeon.messages.Messages;
import com.grottogoblin.otherpixeldungeon.services.news.News;
import com.grottogoblin.otherpixeldungeon.services.updates.AvailableUpdateData;
import com.grottogoblin.otherpixeldungeon.services.updates.Updates;
...
import com.grottogoblin.otherpixeldungeon.windows.WndSettings;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					otherpixeldungeon.switchNoFade( StartScene.class );
				}
			}
		...
		StyledButton btnRankings = new StyledButton(GREY_TR,Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				otherpixeldungeon.switchNoFade( RankingsScene.class );
			}
		};
		...
		StyledButton btnBadges = new StyledButton(GREY_TR, Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				otherpixeldungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		StyledButton btnAbout = new StyledButton(GREY_TR, Messages.get(this, "about")){
			@Override
			protected void onClick() {
				otherpixeldungeon.switchScene( AboutScene.class );
			}
		};
	...
	private static class NewsButton extends StyledButton {
		...
		protected void onClick() {
			super.onClick();
			otherpixeldungeon.switchNoFade( NewsScene.class );
		}
	}
				...
				otherpixeldungeon.scene().addToFront( new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							otherpixeldungeon.switchNoFade( ChangesScene.class );
						}
					}
				});
	...
	private static class SettingsButton extends StyledButton {
		...
		protected void onClick() {
			...
			otherpixeldungeon.scene().add(new WndSettings());
		}
	}
	...
	private static class SupportButton extends StyledButton{
		...
		@Override
		protected void onClick() {
			otherpixeldungeon.switchNoFade(SupporterScene.class);
		}
	}
}
