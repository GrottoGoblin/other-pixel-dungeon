...
package com.grottogoblin.otherpixeldungeon.items.artifacts;
...
import com.grottogoblin.otherpixeldungeon.actors.blobs.CorrosiveGas;
...
import com.grottogoblin.otherpixeldungeon.actors.hero.Belongings;
...
import com.grottogoblin.otherpixeldungeon.actors.mobs.npcs.DirectableAlly;
...
import com.grottogoblin.otherpixeldungeon.effects.particles.ShaftParticle;
...
import com.grottogoblin.otherpixeldungeon.items.bags.Bag;
...
import com.grottogoblin.otherpixeldungeon.scenes.CellSelector;
import com.grottogoblin.otherpixeldungeon.scenes.GameScene;
import com.grottogoblin.otherpixeldungeon.scenes.PixelScene;
import com.grottogoblin.otherpixeldungeon.sprites.GhostSprite;
...
import com.grottogoblin.otherpixeldungeon.windows.IconTitle;
import com.grottogoblin.otherpixeldungeon.windows.WndBag;
import com.grottogoblin.otherpixeldungeon.windows.WndBlacksmith;
import com.grottogoblin.otherpixeldungeon.windows.WndQuest;
import com.grottogoblin.otherpixeldungeon.windows.WndUseItem;
...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (otherpixeldungeon.scene() instanceof GameScene || otherpixeldungeon.scene() instanceof AlchemyScene)){
