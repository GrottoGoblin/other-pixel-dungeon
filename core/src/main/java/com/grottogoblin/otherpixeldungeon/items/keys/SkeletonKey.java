...
package com.grottogoblin.otherpixeldungeon.items.keys;
...
import com.grottogoblin.otherpixeldungeon.windows.WndSupportPrompt;
		...
		if(!SPDSettings.supportNagged()){
			try {
				...
				Game.runOnRenderThread(new Callback() {
					@Override
					public void call() {
						otherpixeldungeon.scene().add(new WndSupportPrompt());
					}
				});
			} catch (IOException e) {
