...
import com.grottogoblin.otherpixeldungeon.actors.blobs.ConfusionGas;
import com.grottogoblin.otherpixeldungeon.actors.blobs.Fire;
import com.grottogoblin.otherpixeldungeon.actors.blobs.ParalyticGas;
import com.grottogoblin.otherpixeldungeon.actors.blobs.Regrowth;
...
import com.grottogoblin.otherpixeldungeon.levels.traps.ShockingTrap;
			...
			case 2:
				...
				try {
					...
					if(Messages.lang() != Languages.ENGLISH){
						...
						otherpixeldungeon.runOnRenderThread(
								new Callback() {
									@Override
									public void call() {
										GameScene.show(
