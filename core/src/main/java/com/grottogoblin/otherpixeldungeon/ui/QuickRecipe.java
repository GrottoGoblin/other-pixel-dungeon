...
package com.grottogoblin.otherpixeldungeon.ui;

import com.grottogoblin.otherpixeldungeon.Dungeon;
import com.grottogoblin.otherpixeldungeon.otherpixeldungeon;
import com.grottogoblin.otherpixeldungeon.items.ArcaneResin;
import com.grottogoblin.otherpixeldungeon.items.Generator;
import com.grottogoblin.otherpixeldungeon.items.Item;
import com.grottogoblin.otherpixeldungeon.items.LiquidMetal;
import com.grottogoblin.otherpixeldungeon.items.Recipe;
import com.grottogoblin.otherpixeldungeon.items.bombs.Bomb;
import com.grottogoblin.otherpixeldungeon.items.food.Blandfruit;
import com.grottogoblin.otherpixeldungeon.items.food.Food;
import com.grottogoblin.otherpixeldungeon.items.food.MeatPie;
...
import com.grottogoblin.otherpixeldungeon.items.food.StewedMeat;
...
import com.grottogoblin.otherpixeldungeon.items.potions.brews.BlizzardBrew;
import com.grottogoblin.otherpixeldungeon.items.potions.brews.CausticBrew;
import com.grottogoblin.otherpixeldungeon.items.potions.brews.InfernalBrew;
import com.grottogoblin.otherpixeldungeon.items.potions.brews.ShockingBrew;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfAquaticRejuvenation;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfArcaneArmor;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfDragonsBlood;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfHoneyedHealing;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfIcyTouch;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.grottogoblin.otherpixeldungeon.items.potions.elixirs.ElixirOfToxicEssence;
...
import com.grottogoblin.otherpixeldungeon.items.spells.Alchemize;
import com.grottogoblin.otherpixeldungeon.items.spells.AquaBlast;
import com.grottogoblin.otherpixeldungeon.items.spells.ArcaneCatalyst;
import com.grottogoblin.otherpixeldungeon.items.spells.BeaconOfReturning;
import com.grottogoblin.otherpixeldungeon.items.spells.CurseInfusion;
import com.grottogoblin.otherpixeldungeon.items.spells.FeatherFall;
import com.grottogoblin.otherpixeldungeon.items.spells.MagicalInfusion;
import com.grottogoblin.otherpixeldungeon.items.spells.PhaseShift;
import com.grottogoblin.otherpixeldungeon.items.spells.ReclaimTrap;
import com.grottogoblin.otherpixeldungeon.items.spells.Recycle;
import com.grottogoblin.otherpixeldungeon.items.spells.SummonElemental;
import com.grottogoblin.otherpixeldungeon.items.spells.TelekineticGrab;
import com.grottogoblin.otherpixeldungeon.items.spells.WildEnergy;
...
public class QuickRecipe extends Component {
	...
	public QuickRecipe(Recipe r, ArrayList<Item> inputs, final Item output) {
		...
		for (final Item in : inputs) {
			...
			curr = new ItemSlot(in) {
				...
				protected void onClick() {
					otherpixeldungeon.scene().addToFront(new WndInfoItem(in));
				}
			};
		...
		this.output = new ItemSlot(output){
			@Override
			protected void onClick() {
				otherpixeldungeon.scene().addToFront(new WndInfoItem(output));
			}
		};
		if (!hasInputs){
	...
	public class arrow extends IconButton {
		...
		protected void onClick() {
			...
			((AlchemyScene)otherpixeldungeon.scene()).populate(ingredients, Dungeon.hero.belongings);
		}
