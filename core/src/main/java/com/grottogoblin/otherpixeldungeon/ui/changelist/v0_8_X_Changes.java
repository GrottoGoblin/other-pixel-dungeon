...
package com.grottogoblin.otherpixeldungeon.ui.changelist;

import com.grottogoblin.otherpixeldungeon.Assets;
import com.grottogoblin.otherpixeldungeon.actors.mobs.DM300;
...
import com.grottogoblin.otherpixeldungeon.scenes.ChangesScene;
import com.grottogoblin.otherpixeldungeon.scenes.PixelScene;
import com.grottogoblin.otherpixeldungeon.sprites.CharSprite;
import com.grottogoblin.otherpixeldungeon.sprites.DM100Sprite;
import com.grottogoblin.otherpixeldungeon.sprites.DM300Sprite;
import com.grottogoblin.otherpixeldungeon.sprites.ElementalSprite;
import com.grottogoblin.otherpixeldungeon.sprites.GuardSprite;
...
import com.grottogoblin.otherpixeldungeon.sprites.KingSprite;
import com.grottogoblin.otherpixeldungeon.sprites.NecromancerSprite;
import com.grottogoblin.otherpixeldungeon.sprites.ShamanSprite;
import com.grottogoblin.otherpixeldungeon.sprites.SpawnerSprite;
import com.grottogoblin.otherpixeldungeon.sprites.StatueSprite;
import com.grottogoblin.otherpixeldungeon.sprites.YogSprite;
import com.grottogoblin.otherpixeldungeon.ui.BuffIcon;
...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.NEWS), "Ingame News Feed",
				...
				"This feed pulls in blog posts from grottogoblin.com, and displays then within the game. It will also notify players when new posts are available.\n\n" +
