...
import com.grottogoblin.otherpixeldungeon.ui.BadgesGrid;
import com.grottogoblin.otherpixeldungeon.ui.BadgesList;
import com.grottogoblin.otherpixeldungeon.ui.Button;
import com.grottogoblin.otherpixeldungeon.ui.CheckBox;
import com.grottogoblin.otherpixeldungeon.ui.IconButton;
import com.grottogoblin.otherpixeldungeon.ui.Icons;
import com.grottogoblin.otherpixeldungeon.ui.ItemSlot;
import com.grottogoblin.otherpixeldungeon.ui.RedButton;
import com.grottogoblin.otherpixeldungeon.ui.RenderedTextBlock;
import com.grottogoblin.otherpixeldungeon.ui.TalentButton;
import com.grottogoblin.otherpixeldungeon.ui.TalentsPane;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						otherpixeldungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						otherpixeldungeon.scene().addToFront(new WndOptions(new Image(icon),
